...
export const auth = {
  ...
  signup: {
    ...
    typeLabel: "What kind of seller are you?",
    typeRetailer: "Retail",
    typeRetailerHint: "Sell directly to shoppers",
    typeWholesaler: "Wholesale",
    typeWholesalerHint: "Bulk sales to businesses/shops — live after approval",
