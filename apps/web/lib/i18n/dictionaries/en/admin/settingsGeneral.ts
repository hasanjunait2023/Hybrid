...
export const settingsGeneral = {
  ...
  domains: {
    ...
    dnsInstruction:
      "Add both records below at your domain provider (e.g. GoDaddy / Namecheap). The A record routes traffic to your store; the TXT record proves you own the domain.",
    caaNote: "If you have a CAA record, add",
    caaNoteSuffix: "— otherwise SSL won't be issued.",
    dnsPropagation:
      "DNS changes can take a few minutes to a few hours to propagate — this is normal. Click \"Check Status\" once you've added both records.",
    retry: "Try again",
    checking: "Checking…",
    ...
    remove: "Remove",
    state: {
      pendingDns: "Waiting for DNS records",
      dnsVerified: "Ownership verified · point A record at us",
      dnsVerifiedSub: "✓ TXT record confirmed. Now add the A record (if not done yet) and click Check Status again.",
