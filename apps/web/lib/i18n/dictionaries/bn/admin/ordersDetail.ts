...
export const ordersDetail: typeof En = {
  ...
  refund: {
    button: "ফেরত দিন",
    title: "ম্যানুয়াল ফেরত",
    close: "বন্ধ করুন",
    remainingLabel: "ফেরতযোগ্য বাকি",
    ...
    payoutLabel: "পেমেন্ট রেফারেন্স (TrxID)",
    payoutPlaceholder: "যেমন: 8N5K3P2X",
    reasonLabel: "কারণ (আবশ্যক)",
    reasonPlaceholder: "যেমন: পণ্য ক্ষতিগ্রস্ত ছিল",
    noteLabel: "অতিরিক্ত নোট",
    notePlaceholder: "ঐচ্ছিক",
    restockLabel: "পণ্য স্টকে ফেরত যাবে",
    cancel: "বাতিল",
    submit: "ফেরত দিন",
    submitting: "প্রসেস হচ্ছে…",
    errorGeneric: "ফেরত প্রদান ব্যর্থ হয়েছে।",
  },
  refundHistory: {
    title: "ফেরতের ইতিহাস",
    empty: "এই অর্ডারে এখনও কোনো ফেরত নেই।",
    method: "মাধ্যম",
    amount: "পরিমাণ",
    reference: "রেফারেন্স",
    initiatedBy: "করেছেন",
