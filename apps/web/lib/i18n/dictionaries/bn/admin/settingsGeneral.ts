...
export const settingsGeneral: typeof En = {
  ...
  domains: {
    ...
    dnsInstruction:
      "আপনার ডোমেইন প্রোভাইডারে (যেমন GoDaddy / Namecheap) নিচের দুটি রেকর্ড যোগ করুন। A রেকর্ড ট্র্যাফিক আনবে, TXT রেকর্ড মালিকানা প্রমাণ করবে।",
    caaNote: "CAA রেকর্ড থাকলে",
    caaNoteSuffix: "যোগ করুন — নাহলে SSL আসবে না।",
    dnsPropagation:
      "DNS ছড়াতে কয়েক মিনিট থেকে কয়েক ঘণ্টা লাগতে পারে। দুটো রেকর্ড যোগ করার পর \"Check Status\" ক্লিক করুন।",
    ...
    remove: "সরান",
    state: {
      pendingDns: "DNS রেকর্ডের অপেক্ষায়",
      dnsVerified: "মালিকানা প্রমাণিত · A রেকর্ড পয়েন্ট করুন",
      dnsVerifiedSub: "✓ TXT রেকর্ড নিশ্চিত হয়েছে। এখন A রেকর্ডটি আমাদের সার্ভারে পয়েন্ট করুন (যদি না করা থাকে), তারপর আবার Check করুন।",
