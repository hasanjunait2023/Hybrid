...
import { BkashIcon } from "@hybrid/ui";
...
export const Sizes = () => (
  <div style={{ display: "flex", alignItems: "center", gap: 24, padding: 32, background: "#fff", color: "#1d4ed8" }}>
    <BkashIcon width={48} height={48} />
    <BkashIcon width={32} height={32} />
    <BkashIcon width={24} height={24} />
    <span style={{ marginLeft: 8, color: "#1c1917", fontFamily: "system-ui, sans-serif", fontSize: 13, fontWeight: 600 }}>BkashIcon</span>
  </div>
);
